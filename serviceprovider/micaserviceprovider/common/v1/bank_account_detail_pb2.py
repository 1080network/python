...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n#common/v1/bank_account_detail.proto\x12\tcommon.v1\x1a\x17validate/validate.proto\"\x90\x02\n\x11\x42\x61nkAccountDetail\x12\x34\n\x1b\x64omestic_ach_routing_number\x18\x01 \x01(\tB\x0f\xfa\x42\x0cr\n2\x08^|\\w{9}$\x12\x39\n international_ach_routing_number\x18\x02 \x01(\tB\x0f\xfa\x42\x0cr\n2\x08^|\\w{9}$\x12,\n\x13wire_routing_number\x18\x03 \x01(\tB\x0f\xfa\x42\x0cr\n2\x08^|\\w{9}$\x12-\n\x14swift_routing_number\x18\x04 \x01(\tB\x0f\xfa\x42\x0cr\n2\x08^|\\w{9}$\x12-\n\x13\x62\x61nk_account_number\x18\x05 \x01(\tB\x10\xfa\x42\rr\x0b\x32\t^|\\w{14}$BQ\n\x11io.mica.common.v1B\x16\x42\x61nkAccountDetailProtoZ\x1dmica/proto/common/v1;commonv1\xa2\x02\x04MICAb\x06proto3')



_BANKACCOUNTDETAIL = DESCRIPTOR.message_types_by_name['BankAccountDetail']
BankAccountDetail = _reflection.GeneratedProtocolMessageType('BankAccountDetail', (_message.Message,), {
  'DESCRIPTOR' : _BANKACCOUNTDETAIL,
  '__module__' : 'common.v1.bank_account_detail_pb2'
  # @@protoc_insertion_point(class_scope:common.v1.BankAccountDetail)
  })
_sym_db.RegisterMessage(BankAccountDetail)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\021io.mica.common.v1B\026BankAccountDetailProtoZ\035mica/proto/common/v1;commonv1\242\002\004MICA'
  ...
  _BANKACCOUNTDETAIL._serialized_start=76
  _BANKACCOUNTDETAIL._serialized_end=348
