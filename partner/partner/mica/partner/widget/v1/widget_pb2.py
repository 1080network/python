...
_INITIALIZEWIDGETREQUEST = DESCRIPTOR.message_types_by_name['InitializeWidgetRequest']
_INITIALIZEWIDGETRESPONSE = DESCRIPTOR.message_types_by_name['InitializeWidgetResponse']
_INITIALIZEWIDGETRESPONSE_STATUS = _INITIALIZEWIDGETRESPONSE.enum_types_by_name['Status']
InitializeWidgetRequest = _reflection.GeneratedProtocolMessageType('InitializeWidgetRequest', (_message.Message,), {
  ...
  '__module__' : 'mica.partner.widget.v1.widget_pb2'
  # @@protoc_insertion_point(class_scope:mica.partner.widget.v1.InitializeWidgetRequest)
  })
...
InitializeWidgetResponse = _reflection.GeneratedProtocolMessageType('InitializeWidgetResponse', (_message.Message,), {
  ...
  '__module__' : 'mica.partner.widget.v1.widget_pb2'
  # @@protoc_insertion_point(class_scope:mica.partner.widget.v1.InitializeWidgetResponse)
  })
