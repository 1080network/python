...
Store = _reflection.GeneratedProtocolMessageType('Store', (_message.Message,), {
  'DESCRIPTOR' : _STORE,
  '__module__' : 'micashared.common.v1.store_pb2'
  # @@protoc_insertion_point(class_scope:micashared.common.v1.Store)
  })
