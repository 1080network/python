...
def add_DiscountFromMicaServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'discount.service.v1.DiscountFromMicaService', rpc_method_handlers)
...
class DiscountFromMicaService(object):
    ...
    def Ping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/discount.service.v1.DiscountFromMicaService/Ping',
